...
const Moons = memo(function Moons({ planetPosition, moons, planetName, planetData, adaptiveDetail = true }) {
  ...
  return prevProps.planetName === nextProps.planetName && prevProps.moons === nextProps.moons;
});
