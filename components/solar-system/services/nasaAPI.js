...
class NASAAPIService {
  ...
  async getMarsRoverPhoto(rover = 'curiosity', sol = 1000) {
    const url = `/api/nasa/mars-rover?rover=${rover}&sol=${sol}`;
    const cacheKey = this._getCacheKey('mars_rover', { rover, sol });
