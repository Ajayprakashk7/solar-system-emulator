      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              onClick={handleDismiss}
              className="w-6 h-6 rounded-full bg-white/10 hover:bg-red-500/30 text-white/60 hover:text-red-300 transition-all duration-200 flex items-center justify-center text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-400 focus-visible:ring-offset-2 focus-visible:ring-offset-black"
            >
              ✕
            </button>
          </div>
