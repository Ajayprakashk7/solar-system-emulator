...
const ExitButton = () => {
  ...
  return (
    ...
    >
      <motion.button
        onClick={handleExit}
        className="bg-black/80 backdrop-blur-md rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:rounded-full px-4 py-2 border border-blue-400/50 hover:border-blue-400/80 hover:bg-blue-500/10 transition-all duration-300 group"
