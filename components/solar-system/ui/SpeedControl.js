    ...
    <>
      ...
      >
        ...
        <motion.div 
          ...
          className={`focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 bg-black/80 backdrop-blur-md rounded-full
                     px-4 py-3 text-xs
