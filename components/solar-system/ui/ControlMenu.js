      ...
      {selectedPlanet && (
        ...
        >
          <motion.button
            ...
            title="Exit View"
            className="bg-black/80 backdrop-blur-md rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-400 focus-visible:rounded-full
                       px-3 py-2 text-xs
                       sm:px-4 sm:py-2 sm:text-sm
