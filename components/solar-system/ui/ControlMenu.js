      ...
      >
        <motion.button
          ...
          className="bg-black/80 backdrop-blur-md rounded-full 
                     ...
                     touch-manipulation focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
        ...
        >
          <motion.button
            ...
            className="bg-black/80 backdrop-blur-md rounded-full 
                       ...
                       transition-all duration-300 group
                       min-h-[40px] min-w-[40px]
                       touch-manipulation focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
            <div className="flex items-center gap-1 sm:gap-2 text-white font-medium">
