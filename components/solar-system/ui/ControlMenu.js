      ...
      >
        <motion.button
          ...
          className="bg-black/80 backdrop-blur-md rounded-full 
                     ...
                     focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:rounded-full
                     touch-manipulation"
        ...
        >
          <motion.button
            ...
            className="bg-black/80 backdrop-blur-md rounded-full 
                       ...
                       transition-all duration-300 group
                       min-h-[40px] min-w-[40px]
                       focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-400 focus-visible:rounded-full
                       touch-manipulation"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
