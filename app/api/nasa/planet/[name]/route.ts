...
export async function GET(
  ...
  try {
    ...
    if (!rateLimitResult.success) {
      nasaLogger.warn(`Global Rate limit exceeded for planet: ${validatedName}`);
      throw new AppError(
        'Rate limit exceeded',
        ERROR_CODES.RATE_LIMIT_EXCEEDED,
        429,
